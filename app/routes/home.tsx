  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center text-gray-800">
      ...
      <p className="text-lg text-gray-700 mb-6">
        This isn't just another tutorial. It’s a hands-on journey to
        building real projects with the exact tools used in
        professional teams:
      </p>
      ...
      <ul className="text-left text-gray-600 mb-8 list-disc list-inside space-y-2">
        ...
        <li className="flex items-start gap-3">
          ...
          />
          <span>
            <strong>React Router v7</strong> (Framework Mode) for
            modern routing with data loading and mutations
          </span>
        </li>
      </ul>

      <p className="text-lg text-gray-700 mb-10">
        If you want to deeply understand how modern websites are
        built, this is the perfect place to start.
      </p>

      <div className="bg-gray-50 border border-gray-200 rounded-lg shadow p-6">
        <p className="text-base text-gray-700 mb-2">
          ✅ Ready to get your hands dirty? Start with the first
          project:
        </p>
